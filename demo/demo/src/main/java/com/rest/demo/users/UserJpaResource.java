...
import com.rest.demo.posts.PostRepository;
...
public class UserJpaResource {
	...
	public UserJpaResource( final UserRepository repository, final PostRepository postRepository) {
	...
	public ResponseEntity<Object> createPostForUser( @PathVariable final int id, @Valid @RequestBody final Post post) {
	...
	public List<Post> retrievePostsForUser(@PathVariable final Integer id ) {
		final Optional<User> user = repository.findById( id);
